...
export const FooterMobile = () => {
  return (
    <footer className="flex bg-[#1b1b1bCC]  gap-6 flex-col">
      <div className="flex items-center justify-center flex-col border-b border-[#000000] px-24 py-12 w-[90%] mx-auto gap-8">
        <h1
      ...
      <div className="flex flex-col w-full items-center gap-8 mx-auto">
        ...
        <p
          className={`${outfitFont.className}font-normal leading-4  text-[#f5f5f5] flex gap-3 items-center `}
        >
          <FaWhatsapp color="#f5f5f5" size={"20px"} />
          Número de telefone: 84 9873-6833
        </p>
        <div className="flex w-full  items-center justify-center ">
          <div className="flex border-[#8D1F73] border px-2 py-2 rounded-lg  gap-3 items-center">

          
          <MdOutlineEmail size={"20px"} color="#f5f5f5" />
          <span
            className={`${outfitFont.className} text-sm font-normal leading-4  text-[#f5f5f5]`}
          >
            E-mail:
