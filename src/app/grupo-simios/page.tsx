...
export default function Simios() {
  ...
  const headerContainer = clsx(`hidden w-full h-52 text-center flex flex-col justify-center gap-2`,
"md:flex pt-10"

  )

  const title = clsx(`
  text-[48px] text-navbar-newblue`,
outfitFont.className
)
  const subtitle = clsx(`
  text-[32px] border-b-2 border-orange-500 w-1/2 ml-auto mr-auto`,
  ZillaFont.className
)
  return (
